...
const removeFile = (index: number) => {
  ...
  if (index >= 0 && index < invoiceData.value.length) {
    const removedFile = invoiceData.value[index]
    console.log("🗑️ 删除的文件:", removedFile.fileName)
