        ...
        <div class="flex justify-between items-center py-1">
          <div class="flex items-center gap-3">
            <h3 class="text-lg font-semibold text-gray-800 m-0 leading-none">
              ...
              <el-tag v-if="invoiceData.length > 0" type="success" size="small">
              {{ invoiceData.length }} 条规则
            </el-tag>

            <span
              class="px-2 font-size-12px py-1 text-blue-600 text-sm rounded-full leading-none flex items-center"
              >(共 {{ invoiceData.length }} 个文件)</span
            >
          </div>
          <div class="flex items-center gap-3">
