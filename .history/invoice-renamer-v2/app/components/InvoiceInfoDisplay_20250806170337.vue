      ...
      <template #header>
        <div class="flex justify-between items-center py-1">
          <div class="flex items-center gap-3">
            ...
            <span
              class="px-2 py-1 bg-blue-5 text-blue-600 text-sm rounded-full leading-none flex items-center"
            ...
            <div class="invoice-info">
              ...
              <div class="amount-section">
                <div class="amount-container">
                  ...
                  <el-tag v-else type="warning" size="small" class="amount-error">未识别</el-tag>
                </div>
                ...
                <div class="expand-toggle">
                  ...
                  >
                    <el-icon class="expand-icon">
                      <ArrowDown v-if="!expandedCards.includes(invoice.fileName)" />
                      <ArrowUp v-else />
                    </el-icon>
                    <span class="expand-text">
                      {{ expandedCards.includes(invoice.fileName) ? "收起" : "详情" }}
                    </span>
                  </el-button>
                </div>
              </div>
...
// 处理删除文件
const handleRemoveFile = (identifier: number | string) => {
  console.log("🗑️ InvoiceInfoDisplay: 删除按钮被点击")
...
.amount-section {
  ...
  margin-top: 12px;
  padding: 8px 12px;
  background: linear-gradient(135deg, rgba(107, 33, 168, 0.04) 0%, rgba(107, 33, 168, 0.06) 100%);
  border-radius: 8px;
...
.amount-section::before {
  ...
  right: 0;
  height: 2px;
  background: linear-gradient(90deg, rgba(107, 33, 168, 0.3), rgba(107, 33, 168, 0.4));
}
