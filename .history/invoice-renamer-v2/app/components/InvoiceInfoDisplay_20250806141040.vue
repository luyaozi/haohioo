      ...
      <template #header>
        <div class="flex justify-between items-center py-1">
          <div class="flex items-center gap-3">
            <h3 class="text-lg font-semibold text-gray-800 m-0 leading-none">发票信息</h3>
            <span
      ...
      <div v-if="viewMode === 'table'" class="table-view">
        <div class="table-wrapper">
          ...
          >
            ...
            <!-- 大写金额 -->
            <el-table-column
              prop="totalAmountChinese"
              label="大写金额"
              min-width="150"
              show-overflow-tooltip
            >
              <template #default="{ row }">
                <span v-if="row.totalAmountChinese" class="amount-chinese">{{
                  row.totalAmountChinese
                }}</span>
                <el-tag v-else type="warning" size="small">未识别</el-tag>
              </template>
            </el-table-column>
            ...
            >
              <template #default="{ row }">
                <span v-if="row.itemName" class="item-name">{{
                  row.itemName
                }}</span>
                <el-tag v-else type="warning" size="small">未识别</el-tag>
              </template>
            ...
            <div class="invoice-info">
              ...
              >
                <div class="expanded-grid">
                  ...
                  <div class="expanded-item">
                    <label>大写金额:</label>
                    <span>{{ invoice.totalAmountChinese || "未识别" }}</span>
                  </div>
                </div>
              </div>
            </div>
