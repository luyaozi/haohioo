  ...
  <div class="rename-results-card">
    <el-card class="results-card" shadow="hover">
      ...
      <div class="results-content">
        ...
        <div v-if="renameResults.length > 0" class="results-list">
          ...
          >
            <div class="result-icon">
              <el-icon v-if="result.error" class="error-icon"><WarningFilled /></el-icon>
            ...
            <div class="result-content">
              ...
              <div class="file-info">
                ...
                <div class="info-item">
                  ...
                  <span class="info-value">{{ formatDate(result.processTime) }}</span>
                </div>
        ...
        <div v-if="renameResults.length > 0" class="results-summary">
          ...
          <div class="summary-content">
            <div class="summary-item">
              ...
              <span class="summary-value">{{ renameResults.length }}</span>
            </div>
            <div class="summary-item">
        ...
        <!-- 批量操作 -->
        <div v-if="renameResults.length > 0" class="batch-actions">
