...
.amount-section {
  ...
  margin-top: 12px;
  padding: 8px 12px;
  background: linear-gradient(135deg, rgba(107, 33, 168, 0.08) 0%, rgba(107, 33, 168, 0.12) 100%);
  border-radius: 8px;
...
.amount-section::before {
  ...
  right: 0;
  height: 2px;
  background: linear-gradient(90deg, rgba(107, 33, 168, 0.6), rgba(107, 33, 168, 0.8));
}
