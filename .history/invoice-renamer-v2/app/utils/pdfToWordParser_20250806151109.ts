...
export class PDFToWordParser {
  ...
  private parseFourColumnStructure(text: string): Partial<ParsedInvoiceInfo> {
    ...
    // 调试：输出所有包含"名称"的行
    console.log('🔍 查找包含"名称"的行...')
    lines.forEach((line, index) => {
      if (line && line.includes("名称")) {
        console.log(`📝 第${index}行包含"名称":`, JSON.stringify(line))
    ...
    try {
      ...
      for (let i = 0; i < lines.length; i++) {
        ...
        if (
          ...
          for (let j = 0; j < columns.length; j++) {
            ...
            if (
              ...
              if (buyerMatch && buyerMatch[1]) {
                ...
                console.log("✅ 找到购买方名称:", result.buyerName)
              }
              buyerNameCol = j
            }
            ...
            if (
              ...
              if (sellerMatch && sellerMatch[1]) {
                ...
                console.log("✅ 找到销售方名称:", result.sellerName)
              }
              sellerNameCol = j
            }
          }
          ...
          if (
            ...
            if (nextCol && !nextCol.includes("售") && !nextCol.includes("方")) {
              ...
              console.log("✅ 从相邻列找到购买方名称:", result.buyerName)
            }
          }
          ...
          if (
            ...
            if (nextCol && !nextCol.includes("买") && !nextCol.includes("方")) {
              ...
              console.log("✅ 从相邻列找到销售方名称:", result.sellerName)
            }
          }
        }
        ...
        if (
          ...
          if (buyerMatch && buyerMatch[1]) {
            result.buyerName = buyerMatch[1].trim()
            console.log("✅ 找到购买方名称(特殊格式):", result.buyerName)
          }
          ...
          if (sellerMatch && sellerMatch[1]) {
            result.sellerName = sellerMatch[1].trim()
            console.log("✅ 找到销售方名称(特殊格式):", result.sellerName)
          }
        }
          ...
          for (let j = 0; j < columns.length; j++) {
            ...
            if (taxIdMatch && taxIdMatch[1]) {
              ...
              if (j < columns.length / 2) {
                ...
                console.log("✅ 设置购买方税号:", result.buyerTaxId)
              } else {
                result.sellerTaxId = taxId
                console.log("✅ 设置销售方税号:", result.sellerTaxId)
              }
            }
          }
        }
      ...
      if (!result.buyerName) {
        ...
        for (const pattern of buyerPatterns) {
          ...
          if (match && match[1]) {
            ...
            console.log("✅ 通过备用模式找到购买方:", result.buyerName)
            break
          }
        }
      }
      ...
      if (!result.sellerName) {
        ...
        for (const pattern of sellerPatterns) {
          ...
          if (match && match[1]) {
            ...
            console.log("✅ 通过备用模式找到销售方:", result.sellerName)
            break
          }
        }
      }
